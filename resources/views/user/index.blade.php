    ...
    <div class="main-nav absolute w-[100%] bg-[transparent] pl-[35px] pr-[35px] pt-[10px] pb-[10px] flex items-center mt-4">
        ...
        <div class="nav-menu bg-[transparent] flex-1">
            <ul class="flex justify-around items-center" id="ul-container">
                <li class="z-10"><a href="{{route('navigation.index')}}" class="text-decoration-none font text-white">Home</a></li>
                <li class="z-10"><a href="{{route('generator.index')}}" class="text-decoration-none font text-white">Generator</a></li>
                <li class="z-10"><a href="{{route('navigation.index')}}" class="text-decoration-none font text-white">About</a></li>
                <li class="z-10"><a href="{{route('navigation.index')}}" class="text-decoration-none font text-white">Blog</a></li>
                <li class="z-10"><a href="{{route('post.index')}}" class="text-decoration-none font text-white">Community</a></li>
