<div class="w-[100%] border-[1px] border-solid border-gray-300 text-center flex flex-col items-center pb-[30px]">
   <div class="mb-[40px] mt-[50px] p-[30px] w-[150px] h-[150px] relative">
    ...
    <div class="p-[20px]">
        <p class="font-bold tetx-[30px]">Reymond Domingo</p>
        ...
        <a class="mb-[20px] mt-[30px] text-[#6FB43F]" target="_blank" href="https://nara-kc.netlify.app/">www.nara.netlify.app</a>
    </div>
    <div class="w-[100%] p-[20px]">
        <div class="flex justify-around mb-[20px] mt-[20px]">
            <div class="flex flex-col"><p>Upvotes</p><span class="text-[#f6941c]">23K</span></div>
            <div class="flex flex-col"><p>Recipes</p><span class="text-[#f6941c]">8</span></div>
        </div>
