@if ($paginator->hasPages())
    <nav class="d-flex justify-items-center justify-content-between position-absolute bottom-0 end-0 me-5">
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between me-3">
            <div>
                <p class="small text-muted me-5">
                    {!! __('Showing') !!}
